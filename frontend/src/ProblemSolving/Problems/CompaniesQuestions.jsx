            ...
            <div className='p-2 col-12 col-md-4'>
                <div className='bg-dark rounded p-4'>
                    ...
                    <ul className='list-unstyled d-flex flex-wrap'>
                        <li> <button onClick={handleShareLink} className='border py-1 px-2 rounded fs-14 d-flex align-items-center me-1 mb-1'><ShareIcon className='fs-6 pe-1' />share</button></li>
